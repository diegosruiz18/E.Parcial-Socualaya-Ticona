...
<!--Contenido-->
      ...
      <div class="content-wrapper fondoCompras">        
        <!-- Main content -->
                    ...
                    <div class="panel-body" style="" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="direccion" id="direccion" maxlength="70" placeholder="Ingrese dirección" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
